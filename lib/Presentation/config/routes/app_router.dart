...
import 'package:restaurant_app/Presentation/views/home/pages/home_page.dart';
import 'package:restaurant_app/Presentation/views/mesas/pages/mesas_page.dart';
import 'package:restaurant_app/Presentation/views/pedidos/pages/pedidos_page.dart';
import 'package:restaurant_app/Presentation/views/pedidos/pages/nuevo_pedido_page.dart';
import 'package:restaurant_app/Presentation/views/cocina/pages/cocina_page.dart';
import 'package:restaurant_app/Presentation/views/menu/pages/menu_page.dart';
import 'package:restaurant_app/Presentation/views/caja/pages/caja_page.dart';
import 'package:restaurant_app/Presentation/views/reportes/pages/reportes_page.dart';
import 'package:restaurant_app/Presentation/views/usuarios/pages/usuarios_page.dart';
import 'package:restaurant_app/Presentation/views/sincronizacion/pages/sincronizacion_page.dart';
import 'package:restaurant_app/Presentation/views/cotizaciones/pages/cotizaciones_page.dart';
import 'package:restaurant_app/Presentation/views/cotizaciones/pages/cotizacion_manual_form_page.dart';
...
import 'package:restaurant_app/Presentation/views/pagina_publica/pages/restaurante_public_page.dart';
import 'package:restaurant_app/Presentation/views/pagina_publica/pages/restaurante_config_page.dart';
import 'package:restaurant_app/Presentation/views/cotizaciones/pages/cotizacion_publica_page.dart';
import 'package:restaurant_app/Presentation/views/backup/backup_page.dart';
import 'package:restaurant_app/Presentation/views/clientes/pages/clientes_page.dart';
import 'package:restaurant_app/Presentation/views/pedidos/pages/pedido_mesa_publica_page.dart';
import 'package:restaurant_app/Presentation/views/home/pages/empresa_config_page.dart';
